	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath}/product?method=findProductByPid&pid=${product.pid}">${product.category.cname}&nbsp;&nbsp;&gt;</a>
				<a>${product.pname}</a>
			</div>
				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a onclick="addProduct()" href="#"> <input
			...
			<script type="text/javascript">
				function addProduct(){
					var pid = ${product.pid};//EL
					var num = $("#quantity").val();//JQ
